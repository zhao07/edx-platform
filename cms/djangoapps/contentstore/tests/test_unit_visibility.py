...
class TestUnitVisibility(ModuleStoreTestCase):
    ...
    def test_verify_course_outline(self):
        ...
        '''
            self.outline_view_xml = etree.fromstring(self.massaged_html)
        from pdb import set_trace; set_trace()

    #self._assert_match(r'<span class="course-title" title="Robot Super Course">Robot Super Course</span>', 'Course title was not found as expected')
        #
        #self._assert_match(r'class="section-name" data-name="Dog"', 'Section "Dog" was not found as expected')
        #self._assert_match(r'class="section-name" data-name="Cat"', 'Section "Cat" was not found as expected')
  ...
  <div class="no-outline-content">
    ...
    var require = {
      ...
      <div class="wrapper wrapper-&lt;%= type %&gt; wrapper-&lt;%= type %&gt;-&lt;%= intent %&gt;
            ...
            &lt;% if(_.contains(['help', 'mini'], intent)) { %&gt;wrapper-&lt;%= type %&gt;-status&lt;% } %&gt;" id="&lt;%= type %&gt;-&lt;%= intent %&gt;" aria-hidden="&lt;% if(obj.shown) { %&gt;false&lt;% } else { %&gt;true&lt;% } %&gt;" aria-labelledby="">
        ...
        <div class="wrapper wrapper-view">
                        ...
                        <h2 class="info-course">
                            ...
                            <a class="course-link"
                                ...
                                <span class="course-org">MITx</span><span class="course-number"
                                    >999</span>
                                <span class="course-title" title="Robot Super Course">Robot Super
                                    Course</span>
                            </a>
                        </h2>
                            ...
                            <ol>
                                <li class="nav-item nav-course-courseware">
                                    <h3 class="title"><span class="label"><span
                                                class="label-prefix sr">Course </span>Content</span>
            ...
            <div id="content">
                    ...
                    <header class="mast has-actions has-subtitle">
                        <h1 class="page-header">
                            ...
                            <ul>
                                ...
                                <li class="nav-item">
                                    <a href="#"
                                        class="button new-button new-courseware-section-button"><i
                                            class="icon-plus"></i> New Section</a>
                                </li>
                                <li class="nav-item">
                                    <a
                                        href="//localhost:8000/courses/MITx/999/Robot_Super_Course/jump_to/i4x://MITx/999/course/Robot_Super_Course"
                                        rel="external" class="button view-button view-live-button"
                                        >View Live</a>
                                </li>
                            </ul>
                        </nav>
                    ...
                    <section class="content">
                                ...
                                <article class="courseware-overview"
                                    ...
                                    > <section
                                        ...
                                        <span
                                            ...
                                            class="section">
                                            <a href="#" data-tooltip="Expand/collapse this section"
                                                class="action expand-collapse collapse">
                                                <i class="icon-caret-down ui-toggle-expansion"></i>
                                                <span class="sr">Expand/collapse this section</span>
                                        ...
                                        <div class="subsection-list">
                                            ...
                                            class="draggable-drop-indicator draggable-drop-indicator-after"
                                                ><i class="icon-caret-right"></i></span> </section>
                                        <section
                                        class="courseware-section is-collapsible is-draggable"
                                        data-parent="MITx.999.Robot_Super_Course/branch/draft/block/Robot_Super_Course"
                        ...
                        <aside class="content-supplementary" role="complimentary">
                            <div class="bit">
                                ...
                                <p>You can create new sections and subsections, set the release date
                                    for sections, and create new units in existing subsections. You
                                    can set the assignment type for subsections that are to be
                                    graded, and you can open a subsection for further editing.</p>
                ...
                <div
                    ...
                    aria-labelledby="dialog-edit-sectionrelease-title" aria-hidden="" role="dialog">
                    <div class="dialog confirm">
                        <form class="edit-sectionrelease-dialog" action="#">
                            <div class="form-content">
                                <h2 class="title dialog-edit-sectionrelease-title">Section Release
                                    Date</h2>
                                <p id="dialog-edit-sectionrelease-description" class="message">On
                                    the date set below, this section - <strong class="section-name"
                                    ></strong> - will be released to students. Any units marked
                                    private will only be visible to admins.</p>
                                <ul class="list-input picker datepair">
                                    <li class="field field-start-date">
                                        <label for="start_date">Release Day</label>
                                        <input class="start-date date" type="text" name="start_date"
                                            value="" placeholder="MM/DD/YYYY" size="15"
                                            autocomplete="off" />
                                    </li>
                                    <li class="field field-start-time">
                                        <label for="start_time">Release Time (<abbr
                                            ...
                                            >UTC</abbr>)</label>
                                        <input class="start-time time" type="text" name="start_time"
                                            value="" placeholder="HH:MM" size="10"
                                            autocomplete="off" />
                                    </li>
                                </ul>
                            </div>
                            <div class="actions">
                                ...
                                <ul>
                                    ...
                                    <li class="action-item">
                                        <a href="#" class="button action-secondary action-cancel"
                                            >Cancel</a>
                                    </li>
                                </ul>
                            </div>
        ...
        require(['js/sock']);
                        ...
                        <header>
                            ...
                            <div class="copy">
                                <p>Need help with Studio? Creating a course is complex, so we're
                                    here to help. Take advantage of our documentation, help center,
                                    as well as our edX101 introduction course for course
                                    authors.</p>
                            </div>
                            <ul class="list-actions">
                                <li class="action-item">
                                    <a href="http://files.edx.org/Getting_Started_with_Studio.pdf"
                                        class="action action-primary" title="This is a PDF Document"
                                        >Download Studio Documentation</a>
                            ...
                            <div class="copy">
                                <p>Have problems, questions, or suggestions about Studio? We're also
                                    here to listen to any feedback you want to share.</p>
                            </div>
                            <ul class="list-actions">
                                <li class="action-item">
                                    <a href="http://help.edge.edx.org/discussion/new"
            ...
            <div class="wrapper-footer wrapper">
                <footer class="primary" role="contentinfo">
                    <div class="colophon">
                        <p> 2013 <a href="http://www.edx.org" rel="external">edX</a>. All rights
                            reserved.</p>
