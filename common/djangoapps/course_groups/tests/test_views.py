...
class AddUsersToCohortTestCase(ModuleStoreTestCase):
    def setUp(self):
        ...
        self.cohort1_users = [UserFactory.create() for i in range(3)]
        self.cohort2_users = [UserFactory.create() for i in range(2)]
        self.cohort3_users = [UserFactory.create() for i in range(2)]
        self.cohortless_users = [UserFactory.create() for i in range(3)]
    ...
    def check_request(
        ...
        actual_users = self.cohort1.users.all()
