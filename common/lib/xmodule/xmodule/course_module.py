                      ...
                      default=[
                          {"short_description": "Putting the structure in place",
                           "items": [{"short_description": "Add course team members",
                                     ...
                                     {"short_description": "Set enrollment / launch dates",
                          ...
                          {"short_description": "Populating your course with content",
                           "items": [{"short_description": "Create (initially private) sections/subsections/units",
                                      "long_description": "Use your course outline to build your sections and subsections.",
                                      "is_checked": False,
                                     ...
                                     {"short_description": "Create any static pages",
                                      "long_description": "Add any static content (e.g. Syllabus, References, Additional Readings, etc...) you might need for your course.",
                                      "is_checked": False,
                                      "action_url": "StaticPages",
                                      "action_text": "Add Static Pages",
                                      "action_external": False},
                                     {"short_description": "Make decisions about grading",
                                      "long_description": "Graded items: set them up, decide on Attempts / Show Answer settings, populate with targeted feedback if desired, create any rubrics for self assessment problems.",
                                      "is_checked": False,
                                      "action_url": "CourseOutline",
                                      "action_text": "Set Up Graded Items",
                                      "action_external": False},
                                     {"short_description": "Set subsection material grading types",
                                      "long_description": "You must set the correct grading type for your subsections containing graded material to be accounted for properly.",
                                      "is_checked": False,
                                      "action_url": "CourseOutline",
                                      "action_text": "Set Grading Types",
                                      "action_external": False},
                                     {"short_description": "Request course 'tab' changes",
                                      "long_description": "Removing a few of the default tabs requires extra work, let us know if you need us to.",
                                      "is_checked": False,
                                      "action_url": "mailto:openedx-courseops@lists.stanford.edu",
                                      "action_text": "Request Tab Changes",
                                      "action_external": True},
                                     {"short_description": "Give meaningful names to course items",
                                      "long_description": "Make sure any items you'll want to see usage reports about, e.g. videos, problems, etc, have names that will be meaningful to students, and meaningful in usage reports (e.g. 'How to multiply matrices' rather than 'Video 16').",
                                      "is_checked": False,
                                      "action_url": "CourseOutline",
                                      "action_text": "Edit Content Names",
                                      "action_external": False},
                                     {"short_description": "(MOOCs only) Work with courseops to incorporate pre/post course surveys",
                                      "long_description": "Pre and post course surveys need to be incorporated into the courses. Our CourseOps staff can help you with that.",
                                      "is_checked": False,
                                      "action_url": "mailto:openedx-courseops@lists.stanford.edu",
                                      "action_text": "Get Help with Surveys",
                                      "action_external": True}]},
                          {"short_description": "Special handling for videos",
                           "items": [{"short_description": "Upload high-res videos to YouTube",
                                     ...
                                     {"short_description": "Request an account for creating captions",
                                      ...
                                      "action_external": True},
                                     {"short_description": "Upload links to YouTube videos to caption provider",
                                      "long_description": "Access the Studio Help forum from the menu that appears when you click your user name in the top right corner of Studio.",
                                      "is_checked": False,
                                      "action_url": "https://groups.google.com/d/forum/openedx-studio",
                                      "action_text": "Visit Studio Help",
                                      "action_external": True},
                                     {"short_description": "Confirm that captions are on YouTube",
                                      "long_description": "Register for edX 101, edX's primer for course creation.",
                                      "is_checked": False,
                                      "action_url": "https://edge.edx.org/courses/edX/edX101/How_to_Create_an_edX_Course/about",
                                      "action_text": "Register for edX 101",
                                     ...
                                     {"short_description": "Create smaller versions of videos for download",
                                      ...
                                      "action_text": "Register for edX 101",
                                      "action_external": True},
                                     {"short_description": "Upload downloadable videos (e.g. to stanford.box.com)",
                                      "long_description": "Access the Studio Help forum from the menu that appears when you click your user name in the top right corner of Studio.",
                                      "is_checked": False,
                                      "action_url": "https://groups.google.com/d/forum/openedx-studio",
                                      "action_text": "Visit Studio Help",
                                     ...
                                     {"short_description": "Create download links for smaller videos",
                                      ...
                                      "action_text": "Register for edX 101",
                                      "action_external": True},
                                     {"short_description": "Create caption download links",
